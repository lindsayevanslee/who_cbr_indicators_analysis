    ...
    if (is.null(input_file)) return(NULL)
      ...
      df_uploading <- df_uploading %>%  
        ...
        mutate(
          ...
          AGE = factor(plyr::mapvalues(I09, from = c('0-5','6-12', '13-17', '18-24', '25-44', '45-64', '65+'), to = c("Child", "Child", "Child", "Adult", "Adult", "Adult", "Adult"))),
          #Health
  ...
  list_tables <- reactive({
    ...
    if (!is.null(df_uploaded())) {
      list(
        ...
        table2_2 = tab_cbr(df_uploaded(), vars_indicators = c("AGE"), vars_demo = c("I04", "I05"), value = "n"), #FIX
        table3 = tab_cbr(df_uploaded(), vars_indicators = c("I05", "I09", "E01"), vars_demo = c("I04")), # FIX
        ...
        table4_2 = tab_cbr(df_uploaded(), vars_indicators = c("H01"), vars_demo = c("I04", "I05"), AGE=="Adult", resp_values = 1:2, value = "prop") %>% 
          bind_rows(tab_cbr(df_uploaded(), vars_indicators = c("H02"), vars_demo = c("I04", "I05"), AGE=="Adult", resp_values = 4:5, value = "prop")),
        ...
        table5_2 = tab_cbr(df_uploaded(), vars_indicators = c("H01"), vars_demo = c("I04", "I05"), AGE=="Child", resp_values = 1:2, value = "prop") %>% 
          bind_rows(tab_cbr(df_uploaded(), vars_indicators = c("H02"), vars_demo = c("I04", "I05"), AGE=="Child", resp_values = 4:5, value = "prop")),
        table6_1 = tab_cbr(df_uploaded(), vars_indicators = c("H03"), vars_demo = c("I04"), resp_values = 1, AGE=="Adult"),
        table6_2 = tab_cbr(df_uploaded(), vars_indicators = c("H03"), vars_demo = c("I04", "I05"), resp_values = 1, AGE=="Adult", value = "prop"),
        table7_1 = tab_cbr(df_uploaded(), vars_indicators = c("H03"), vars_demo = c("I04"), resp_values = 1, AGE=="Child"),
        table7_2 = tab_cbr(df_uploaded(), vars_indicators = c("H03"), vars_demo = c("I04", "I05"), resp_values = 1, AGE=="Child", value = "prop"),
        table8_1 = tab_cbr(df_uploaded(), vars_indicators = c("H05"), vars_demo = c("I04"), AGE=="Adult"),
        table8_2 = tab_cbr(df_uploaded(), vars_indicators = c("H05"), vars_demo = c("I04", "I05"), AGE=="Adult", value = "prop"),
        table9_1 = tab_cbr(df_uploaded(), vars_indicators = c("H05"), vars_demo = c("I04"), AGE=="Child"),
        table9_2 = tab_cbr(df_uploaded(), vars_indicators = c("H05"), vars_demo = c("I04", "I05"), AGE=="Child", value = "prop"),
        ...
        table11_2 = tab_cbr(df_uploaded(), vars_indicators = c("H08"), vars_demo = c("I04", "I05"), AGE=="Adult", value = "prop"),
        table12_1 = tab_cbr(df_uploaded(), vars_indicators = c("H08"), vars_demo = c("I04"), AGE=="Child"),
        table12_2 = tab_cbr(df_uploaded(), vars_indicators = c("H08"), vars_demo = c("I04", "I05"), AGE=="Child", value = "prop"),
        ...
        table16_2 = tab_cbr(df_uploaded(), vars_indicators = c("E01"), vars_demo = c("I04", "I05"), AGE=="Adult", value = "prop"),
        table17_1 = tab_cbr(df_uploaded(), vars_indicators = c("E01"), vars_demo = c("I04"), I09=="6-12", resp_values = 2),
        table17_2 = tab_cbr(df_uploaded(), vars_indicators = c("E01"), vars_demo = c("I04", "I05"), I09=="6-12", value = "prop", resp_values = 2),
        table18_1 = tab_cbr(df_uploaded(), vars_indicators = c("E01"), vars_demo = c("I04"), I09=="13-17", resp_values = 3),
        table18_2 = tab_cbr(df_uploaded(), vars_indicators = c("E01"), vars_demo = c("I04", "I05"), I09=="13-17", value = "prop", resp_values = 3),
        ...
        table20_2 = tab_cbr(df_uploaded(), vars_indicators = c("E04"), vars_demo = c("I04", "I05"), value = "prop", resp_values = 1),
        table21_1 = tab_cbr(df_uploaded(), vars_indicators = c("L02"), vars_demo = c("I04"), resp_values = 4:5),
        table21_2 = tab_cbr(df_uploaded(), vars_indicators = c("L02"), vars_demo = c("I04", "I05"), value = "prop", resp_values = 4:5),
        table22_1 = tab_cbr(df_uploaded(), vars_indicators = c("L01"), vars_demo = c("I04"), resp_values = 5),
        table22_2 = tab_cbr(df_uploaded(), vars_indicators = c("L01"), vars_demo = c("I04", "I05"), value = "prop", resp_values = 5),
        table23_1 = tab_cbr(df_uploaded(), vars_indicators = c("L01"), vars_demo = c("I04"), resp_values = 3),
        table23_2 = tab_cbr(df_uploaded(), vars_indicators = c("L01"), vars_demo = c("I04", "I05"), value = "prop", resp_values = 3),
        table24_1 = tab_cbr(df_uploaded(), vars_indicators = c("L04"), vars_demo = c("I04"), resp_values = 1),
        table24_2 = tab_cbr(df_uploaded(), vars_indicators = c("L04"), vars_demo = c("I04", "I05"), value = "prop", resp_values = 1),
        table25_1 = tab_cbr(df_uploaded(), vars_indicators = c("L05", "L06"), vars_demo = c("I04"), resp_values = 1),
        table25_2 = tab_cbr(df_uploaded(), vars_indicators = c("L05", "L06"), vars_demo = c("I04", "I05"), value = "prop", resp_values = 1),
        table26_1 = tab_cbr(df_uploaded(), vars_indicators = c("S01"), vars_demo = c("I04"), resp_values = 4:5),
        table26_2 = tab_cbr(df_uploaded(), vars_indicators = c("S01"), vars_demo = c("I04", "I05"), value = "prop", resp_values = 4:5),
        table27_1 = tab_cbr(df_uploaded(), vars_indicators = c("S02"), vars_demo = c("I04"), resp_values = 4:5),
        table27_2 = tab_cbr(df_uploaded(), vars_indicators = c("S02"), vars_demo = c("I04", "I05"), value = "prop", resp_values = 4:5),
        table28_1 = tab_cbr(df_uploaded(), vars_indicators = c("S03"), vars_demo = c("I04"), resp_values = 4:5),
        table28_2 = tab_cbr(df_uploaded(), vars_indicators = c("S03"), vars_demo = c("I04", "I05"), value = "prop", resp_values = 4:5),
        table29_1 = tab_cbr(df_uploaded(), vars_indicators = c("S04"), vars_demo = c("I04"), resp_values = 4:5),
        table29_2 = tab_cbr(df_uploaded(), vars_indicators = c("S04"), vars_demo = c("I04", "I05"), value = "prop", resp_values = 4:5),
        table30_1 = tab_cbr(df_uploaded(), vars_indicators = c("S05"), vars_demo = c("I04"), resp_values = 4:5),
        table30_2 = tab_cbr(df_uploaded(), vars_indicators = c("S05"), vars_demo = c("I04", "I05"), value = "prop", resp_values = 4:5),
        ...
        table31_2 = tab_cbr(df_uploaded(), vars_indicators = c("S06"), vars_demo = c("I04", "I05"), value = "prop", resp_values = 4:5) %>% 
          bind_rows(tab_cbr(df_uploaded(), vars_indicators = c("S07"), vars_demo = c("I04", "I05"), resp_values = 1)),
        table32_1 = tab_cbr(df_uploaded(), vars_indicators = c("M01", "M02"), vars_demo = c("I04"), resp_values = 4:5),
        table32_2 = tab_cbr(df_uploaded(), vars_indicators = c("M01", "M02"), vars_demo = c("I04", "I05"), value = "prop", resp_values = 4:5),
        table33_1 = tab_cbr(df_uploaded(), vars_indicators = c("M04"), vars_demo = c("I04"), resp_values = 4:5),
        table33_2 = tab_cbr(df_uploaded(), vars_indicators = c("M04"), vars_demo = c("I04", "I05"), value = "prop", resp_values = 4:5),
        table34_1 = tab_cbr(df_uploaded(), vars_indicators = c("M05"), vars_demo = c("I04"), resp_values = 1),
        table34_2 = tab_cbr(df_uploaded(), vars_indicators = c("M05"), vars_demo = c("I04", "I05"), value = "prop", resp_values = 1),
        table35_1 = tab_cbr(df_uploaded(), vars_indicators = c("M06"), vars_demo = c("I04")),
        table35_2 = tab_cbr(df_uploaded(), vars_indicators = c("M06"), vars_demo = c("I04", "I05"), value = "prop"),
        ...
        table36_2 = tab_cbr(df_uploaded(), vars_indicators = c("Q01"), vars_demo = c("I04", "I05"), value = "prop", resp_values = 1:2) %>% 
          bind_rows(tab_cbr(df_uploaded(), vars_indicators = paste0("Q0",2:7), vars_demo = c("I04", "I05"), value = "prop", resp_values = 4:5))
